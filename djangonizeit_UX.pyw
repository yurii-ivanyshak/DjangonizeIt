...
class DjangoImages(QtWidgets.QWidget):
    ...
    def _elements(self):
        ...
        self.djangonizeButton = self.create_button("Djangonize It!", self.djangonize,
                                                   tooltip="Download the image,return the django link, log the result")
...
class DjangoFiles(DjangoImages):
    ...
    def _elements(self):
        ...
        self.djangonizeButton = self.create_button("Djangonize It!", self.djangonize,
                         tooltip="Make a copy of the file where pattern links are replacing by django links, "
                                 "return name of the copy")
        self.djangonizeLine = self.create_line_edit(
                                        tooltip=" The name of changed file will arise here after djangonization")
        self.openButton = self.create_button("Open It!", self.open_file,
                                         tooltip="Open folder with djangonized file, "
                                                 "fill its name to the combobox of os explorer")
        self.quitButton = self.create_button('Quit', self.quit_app(), tooltip="Close All Windows")
    ...
    def djangonize(self):
        ...
        dirList = self.dir_list(os.getcwd())         # DjangonizeImage inherited method which returns folders before static folder
...
class DjangoTemplates(DjangoFiles):
    ...
    def _view(self):
        ...
        self.fileGroupBox.setTitle("Browse the templates folder:")
    ...
    def _elements(self):
        ...
        self.browseButton = self.create_button("Browse...", self.browse, tooltip='Browse the templates folder')
